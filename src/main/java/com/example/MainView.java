    ...
    public MainView() {
        ...
        addButton.addClickListener(click -> {
            ...
            if (task1.isEmpty()){
                ...
                task2.addClassName("active");
                task1.removeClassName("active");
            } else {
                if (task2.isEmpty()){
                    task2.setValue(true);
                    task2.setLabel("You have created your blueprint");
                    task3.addClassName("active");
                    task2.removeClassName("active");
                } else {
                    if (task3.isEmpty()){
                        task3.setValue(true);
                        task3.setLabel("You have created an import mapping");
                        task4.addClassName("active");
                        task3.removeClassName("active");
                    } else {
                        if (task4.isEmpty()){
                            task4.setValue(true);
                            task4.setLabel("you have imported your product data");
                            task4.removeClassName("active");
